                ...
                <div className="flex items-center gap-6 mr-18">
                    <div className="relative ">
                        <input
                            ...
                            className="border border-gray-300 rounded-full py-2 px-4 w-full text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                        />
                        <i className="fa-solid fa-search absolute top-2 right-3"></i>
                    </div>

                    <div>
                        <h1 className="text-lg font-bold text-purple-950">JNTUK</h1>
                    </div>
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <a href="#" className="flex items-center mr-6">
                            <i className="fa-sharp fa-regular fa-envelope text-xl font-bold"></i>
                        </a>
                        <img
